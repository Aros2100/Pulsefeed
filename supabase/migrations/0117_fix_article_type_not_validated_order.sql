-- Prioritize AI-scored articles first so the lab session shows them immediately
-- after scoring completes (unscored articles still appear but at the end)
...
LANGUAGE sql STABLE AS $fn$
  ...
  ORDER BY
    CASE WHEN a.article_type_ai IS NULL THEN 1 ELSE 0 END,  -- AI-scorede først
    a.imported_at DESC
  LIMIT p_limit;
$fn$;
