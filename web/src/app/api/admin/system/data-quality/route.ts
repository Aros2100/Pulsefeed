...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    author_location: {
      with_region:          Number(authorStats.region_coverage)      || 0,
      with_country:         Number(authorStats.country_coverage)     || 0,
      with_state:           Number(authorStats.state_coverage)       || 0,
      with_city:            Number(authorStats.city_coverage)        || 0,
      ...
      with_region_pct:  totalA > 0 ? Math.round((Number(authorStats.region_coverage)  || 0) / totalA * 100) : 0,
      with_country_pct: totalA > 0 ? Math.round((Number(authorStats.country_coverage) || 0) / totalA * 100) : 0,
      with_state_pct:   totalA > 0 ? Math.round((Number(authorStats.state_coverage)   || 0) / totalA * 100) : 0,
      with_city_pct:    totalA > 0 ? Math.round((Number(authorStats.city_coverage)    || 0) / totalA * 100) : 0,
    },
    article_location: {
