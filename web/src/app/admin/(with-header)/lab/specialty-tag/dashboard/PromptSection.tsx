...
export default function PromptSection({ versions, specialty, module, totalDisagreements }: Props) {
  ...
  const hasSufficientData = totalDisagreements >= 0;
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "6px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          {hasSufficientData ? (
            ...
            <span
              title={`Need at least 0 disagreements first (${totalDisagreements} so far)`}
      ...
      {!hasSufficientData && (
        <div style={{ background: "#fef2f2", border: "1px solid #fecaca", borderRadius: "7px", padding: "9px 14px", marginBottom: "10px", display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <span style={{ fontSize: "12px", color: "#b91c1c" }}>
            Need at least 0 disagreements before optimizing the prompt ({totalDisagreements} so far)
          </span>
        </div>
      )}
