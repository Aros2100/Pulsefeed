...
export default async function CondensationTextOptimizePage() {
      ...
      <div style={{ maxWidth: "960px", margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <div style={{ marginBottom: "24px" }}>
          <div style={{ fontSize: "11px", letterSpacing: "0.08em", color: "#059669", textTransform: "uppercase" as const, fontWeight: 700, marginBottom: "6px" }}>
            Prompt Optimization · Text Condensation
          </div>
          <h1 style={{ fontSize: "22px", fontWeight: 700, margin: 0 }}>
            Optimize Model · {specialtyLabel}
          </h1>
          <p style={{ fontSize: "13px", color: "#888", marginTop: "6px" }}>
            Identificér mønstre i afvisninger og generér en forbedret tekst-kondenseringsprompt
          </p>
        </div>
        ...
        <PatternAnalysis
          ...
          accentColor="#059669"
          threshold={0}
          simulatePath="/admin/lab/condensation-text/simulate"
