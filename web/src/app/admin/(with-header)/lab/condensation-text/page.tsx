...
export default async function CondensationTextOverviewPage() {
      ...
      <div style={{ maxWidth: "860px", margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <div style={{ marginBottom: "36px" }}>
          ...
          <p style={{ fontSize: "13px", color: "#888", marginTop: "6px" }}>
            Validate AI-generated headline, summary and bottom line
          </p>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <SectionCard
            ...
            kpis={[
              {
                ...
                valueColor: queueCount > 0 ? "#059669" : undefined,
              },
              {
                label: "Bearbejdet",
            ...
            actionHref="/admin/lab/condensation-text/session"
            actionColor="#059669"
          />
          ...
          <SectionCard
            ...
            actionHref="/admin/lab/condensation-text/dashboard"
          />
          ...
          <SectionCard
            ...
            actionHref="/admin/lab/condensation-text/evaluation"
            actionColor="#d97706"
          />
