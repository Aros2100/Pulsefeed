...
export default function ClassificationSimulatorClient({
  runId,
  specialty,
  module,
  baseVersion,
  ...
  const filteredRows = disagreements.filter((d) => {
    ...
    const sim = simResults.get(d.article_id);
    const fixed = sim ? arraysEqual(parseTags(sim.decision), parseTags(d.human_decision)) : false;
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <div style={{ marginBottom: "28px" }}>
          <div style={{ fontSize: "11px", letterSpacing: "0.08em", color: ACCENT, textTransform: "uppercase", fontWeight: 700, marginBottom: "6px" }}>
            Prompt Simulator · Classification
          </div>
                ...
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  ...
                  <tbody>
                    {filteredRows.map((d, i) => {
                      ...
                      const fixed = sim ? arraysEqual(newAiTags, humanTags) : false;
                      return (
                        <tr key={d.article_id} style={{ background: i % 2 === 1 ? "#fafafa" : "#fff" }}>
                          ...
                          <td style={tdStyle}>
                            <SubspecialtyBadges tags={humanTags} color="blue" />
                          </td>
                          <td style={tdStyle}>
                            <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                              <SubspecialtyBadges tags={oldAiTags} color="purple" />
                          ...
                          <td style={tdStyle}>
                            {sim ? (
                              <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                                <SubspecialtyBadges tags={newAiTags} color="green" />
                                {sim.confidence > 0 && (
                        ...
                        <tr key={d.article_id} style={{ background: i % 2 === 1 ? "#fafafa" : "#fff" }}>
                          ...
                          <td style={tdStyle}>
                            <textarea
                              ...
                              placeholder={isRegression ? "Fx: Korrekt — ren neurologi" : "Valgfri kommentar"}
                              rows={2}
                              style={{
                                width: "100%", boxSizing: "border-box",
