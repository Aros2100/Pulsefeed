...
export default async function ClassificationOptimizePage() {
  ...
  const hasSufficientData = totalDisagree >= 25;
  const dataBanner = totalDisagree < 25
    ? { bg: "#fef2f2", border: "#fecaca", dot: "#dc2626", text: "#b91c1c", msg: `Insufficient data — need at least 25 disagreements to identify reliable trends (${totalDisagree} so far${versionSuffix})` }
