...
export function buildV1Request(
  ...
  const system = [
    ...
    "    \"dimensions\": {",
    "      \"bias\": {\"score\": <1-10 or null>, \"applicability\": <\"scored\"|\"neutral\"|\"not_applicable\">},",
    "      \"statistical_analyses\": {\"score\": ..., \"applicability\": ...},",
    "      \"study_design\": {\"score\": ..., \"applicability\": ...},",
    "      \"outcome_quality\": {\"score\": ..., \"applicability\": ...},",
    "      \"sample_size\": {\"score\": ..., \"applicability\": ...},",
    "      \"intervention_integrity\": {\"score\": ..., \"applicability\": ...},",
    "      \"protocol_adherence\": {\"score\": ..., \"applicability\": ...},",
    "      \"consistency\": {\"score\": ..., \"applicability\": ...},",
    "      \"generalizability\": {\"score\": ..., \"applicability\": ...},",
    "      \"reproducibility\": {\"score\": ..., \"applicability\": ...}",
    "    },",
    "    \"reasoning\": \"<2-4 sentences summarizing strongest and weakest dimensions>\"",
    "  }",
    "  applicability MUST be one of: 'scored' (concrete evidence), 'neutral' (dimension applicable but",
    "  abstract doesn't describe it clearly — use a fallback value like 4-6), or 'not_applicable'",
    "  (the study type fundamentally cannot be assessed on this dimension — score must be null).",
