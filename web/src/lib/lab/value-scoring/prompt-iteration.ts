...
export function buildV1Request(
  ...
  const system = [
    ...
    "    \"dimensions\": {",
    "      \"bias\": {\"score\": <1-10 or null>, \"status\": <\"scored\"|\"neutral\"|\"not_applicable\">},",
    "      \"statistical_analyses\": {\"score\": ..., \"status\": ...},",
    "      \"study_design\": {\"score\": ..., \"status\": ...},",
    "      \"outcome_quality\": {\"score\": ..., \"status\": ...},",
    "      \"sample_size\": {\"score\": ..., \"status\": ...},",
    "      \"intervention_integrity\": {\"score\": ..., \"status\": ...},",
    "      \"protocol_adherence\": {\"score\": ..., \"status\": ...},",
    "      \"consistency\": {\"score\": ..., \"status\": ...},",
    "      \"generalizability\": {\"score\": ..., \"status\": ...},",
    "      \"reproducibility\": {\"score\": ..., \"status\": ...}",
    "    },",
    "    \"reasoning\": \"<2-4 sentences summarizing strongest and weakest dimensions>\"",
    "  }",
    "  status MUST be one of: 'scored' (concrete evidence), 'neutral' (dimension applicable but",
