-- Remove news_value and clinical_relevance from get_newsletter_articles
-- Both columns have been dropped from the articles table.
...
RETURNS TABLE(
  ...
  title           text,
  journal_abbr    text,
  pubmed_indexed_at timestamp with time zone,
...
LANGUAGE sql STABLE AS $$
  SELECT DISTINCT ON (a.id)
    ...
    a.imported_at,
    a.authors, a.article_type,
    a.short_resume, a.abstract,
  ...
  ORDER BY a.id, a.imported_at DESC NULLS LAST;
$$;
